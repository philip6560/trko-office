...
class SlidableCardTemplate extends StatelessWidget {
  ...
  final String dateTime, note, amount;

  SlidableCardTemplate({Key key, this.note, this.dateTime, this.amount}) : super(key: key);
...
class CardTemplate3 extends StatelessWidget {
  ...
  const CardTemplate3({Key key, this.dateTime, this.amount, this.note}) : super(key: key);
