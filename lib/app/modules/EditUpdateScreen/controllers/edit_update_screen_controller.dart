...
class EditUpdateScreenController extends GetxController {
  ...
  validate() async{
    if(formkey.value.currentState.validate()) {
      ...
      result = await trkoRepository.editUpdate(updateData: updateData, token: Get.find<HomeScreenController>().token.value,
  ...
  @override
  void onReady() {
    getMilestoneId(updatesScreenController.milestone);
    super.onReady();
  }
